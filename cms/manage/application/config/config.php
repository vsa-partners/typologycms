...
// Why was this turned off? Need the http for sending links in emails.

$config['base_url']	= 'http://' . $_SERVER["HTTP_HOST"] . SITEPATH . 'manage/';
//$config['base_url']	= SITEPATH . 'manage/';
...
|
*/
$config['sess_cookie_name']		= 'ci_manage';
