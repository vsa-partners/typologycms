		<div id="tab_children" class="tab_content">
			...
			<button type="button" class="button button_small" onclick="document.location = this.getAttribute('href'); this.blur();" href="<?=$this->admin_path.'page/create/'.$fields[$this->id_field]?>"><span>ADD</span></button>
			<br/><br/>					
