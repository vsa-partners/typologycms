...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="*[@type = 'date']">
		...
		<div class="form_row">
			...
			<div class="field">
				<input class="action_calendar" type="text" title="{@title}" name="{$item_id}[value]" id="{$item_id}" readonly="readonly" style="width: 100px;">
			...
			<div class="note">Format: YYYY-MM-DD</div>
